    ...
    <Stack direction={['column', 'row']} h="100vh">
      <VStack w="full">
        ...
        <VStack alignItems={'flex-start'} p="8" w="full" overflow={'auto'}>
          ...
          <Text>
            {' '}
            this is sample videos Lorem ipsum, dolor sit amet consectetur
            adipisicing elit. Accusantium obcaecati assumenda consequatur fugiat
            maiores dolorem itaque, minima ipsa rem soluta id repudiandae quam
            ad molestias nobis eligendi perferendis vitae accusamus? this is
            sample videos Lorem ipsum, dolor sit amet consectetur adipisicing
            elit. Accusantium obcaecati assumenda consequatur fugiat maiores
            dolorem itaque, minima ipsa rem soluta id repudiandae quam ad
            molestias nobis eligendi perferendis vitae accusamus? this is sample
            videos Lorem ipsum, dolor sit amet consectetur adipisicing elit.
            Accusantium obcaecati assumenda consequatur fugiat maiores dolorem
            itaque, minima ipsa rem soluta id repudiandae quam ad molestias
            nobis eligendi perferendis vitae accusamus? this is sample videos
            ...
            Accusantium obcaecati assumenda consequatur fugiat maiores dolorem
            itaque, minima ipsa rem soluta id repudiandae quam ad molestias
            nobis eligendi perferendis vitae accusamus?
          </Text>
        </VStack>
      </VStack>
      <VStack
